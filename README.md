...
Create virtual environment (Important, Python 3.12.10) (Also, in model_manager subprocess calling yolo.py will run on .venv environment)
``bash python -m venv mediscan_env``

Activate on Windows:
``bash mediscan_env\Scripts\activate``
